...
import { ArrowDownward, ArrowForwardIos, EmailOutlined, FontDownloadRounded, GetApp, MoreHorizOutlined } from '@material-ui/icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faAddressCard, faCoffee, faFileAlt, faLink } from '@fortawesome/free-solid-svg-icons'
...
function QR() {
    ...
    const data={
        email:[{heading:'Email QR',input:true,button:'Generate'},{label:'Email ID',inputs:{text:['Enter mail id']}},{lable:'Subject',inputs:{text:['Enter the subject']}},{label:'Body',inputs:{textarea:['enter the body']}}],
        wifi:[{heading:'Wifi QR',input:true,button:'Generate'},{label:'Email ID',inputs:{text:[''],checkbox:['hidden']}},{label:'password',inputs:{text:['']}},{label:'Encryption',inputs:{radio:['none','WPA3/WPA2','WEP']}}],
        vcard:[{heading:'V Card QR',input:true,button:'Generate'},{label:'Name',inputs:{text:['Enter first name','enter last name']}},{label:'Contact',inputs:{text:['enter phone number','enter fax']}},{label:'Email ID',inputs:{text:['enter email id']}},
    ...
    text:[{heading:'Text QR',button:false,content:'Enter the text that you want to show'}],
    app:[{heading:'App store QR',button:'Sign up for free',content:'Link your app in Apple App Store, Google Play Store, or Amazon Appstore on one page.'}],
    link:[{heading:'Enter URL here',file:true},{label:false,inputs:{file:['']}}],
    bitcoin:[{heading:'Bitcoin QR',input:true,button:'Sign up for free'},{label:'Cryptocurrency',inputs:{radio:['Bitcoin','Dodge','Ether','Other']}},{label:'',inputs:{text:['Enter type of crypto']}}
    ,{label:'Amount',inputs:{text:['Enter the amount']}},
    {label:'Reciever',inputs:{text:['Enter the address']}},
    {label:'Message',inputs:{text:['optional']}}

],
twitter:[{heading:'Twitter QR',input:true,button:'Sign up for free'},{label:'Choose an option',inputs:{radio:['Post','Profile']}},{label:'Text',inputs:{textarea:['Enter your article']}},{label:false,inputs:{file:['']}}]
    ,facebook:[{heading:'Facebook QR',input:true,button:'Sign up for free'},{label:'Choose an option',inputs:{radio:['Post','Profile']}},{label:'Text',inputs:{textarea:['Enter your article']}},{label:false,inputs:{file:['']}}]
